...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .consent-row { display: flex; align-items: flex-start; gap: 10px; background: #1a1a1a; border: 1px solid #2d2d2d; border-radius: 8px; padding: 14px; }
    .consent-row input[type="checkbox"] { width: 18px; height: 18px; min-width: 18px; margin-top: 1px; accent-color: #22c55e; cursor: pointer; padding: 0; }
...
<body>
  ...
  <form method="POST" action="/connect">
    ...
    <div class="field"><label for="interest">What are you interested in?</label>
...
// Pages Function: handle GET (show form) and POST (process submission)
